...
| **Preact** | `@better-captcha/preact` | `npm i @better-captcha/preact` |
...
| **[Altcha](/docs/provider/altcha)** | Privacy-focused proof-of-work CAPTCHA | N/A |
...
- Select a provider at runtime with the [dynamic provider component](/docs/dynamic-provider)
