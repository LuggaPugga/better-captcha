...
function generateComponentFiles(metadata: ProviderMetadata): GeneratedFiles {
	...
	sourceFile.addVariableStatement({
		...
		declarations: [
			{
				name: componentName,
				initializer: `createCaptchaComponent(${providerClassName})`,
			},
		],
	});
...
export declare const ${componentName}: DefineComponent<CaptchaProps<Omit<${renderParamsType}, ${renderParamsOmit}>>, CaptchaEmits<${handleType}>>;
