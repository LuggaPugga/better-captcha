...
import { type FrameworkConfig, generateAggregateIndexFile } from "@better-captcha/core/utils/build-plugin-utils";
...
function generateComponentFile(metadata: ProviderMetadata): string {
	...
	// Rename private-captcha to private-captcha-widget to avoid reserved keyword
...
export declare const ${componentName}: typeof LitElement;

export type ${componentName}Props = CaptchaProps<Omit<${renderParamsType}, ${renderParamsOmit}>>;
