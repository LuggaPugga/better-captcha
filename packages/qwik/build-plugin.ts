...
function genIndexDts(): string {
	...
	sourceFile.addImportDeclaration({
		namedImports: ["CaptchaHandle", "CaptchaResponse", "ProviderName", "ScriptOptions"],
		moduleSpecifier: "@better-captcha/core",
		isTypeOnly: true,
	});

	sourceFile.addImportDeclaration({
		namedImports: ["Component", "NoSerialize", "QRL", "Signal"],
	...
	sourceFile.addExportDeclaration({
		namedExports: ["CaptchaHandle", "CaptchaState", "Provider", "ProviderConfig", "ProviderName", "ScriptOptions", "WidgetId"],
		moduleSpecifier: "@better-captcha/core",
		isTypeOnly: true,
	});
	...
	sourceFile.addTypeAlias({
		name: "BetterCaptchaProps",
		type: `CaptchaProps<Record<string, unknown>, CaptchaHandle<CaptchaResponse>, CaptchaResponse> & {
	...
	sourceFile.addVariableStatement({
		...
		isExported: true,
		declarations: [{ name: "BetterCaptcha", type: "Component<BetterCaptchaProps>" }],
	});
		...
		parameters: [
			{
				...
				type: "QRL<(value: string, scriptOptions?: ScriptOptions) => TProvider | Promise<TProvider>>",
			},
		],
