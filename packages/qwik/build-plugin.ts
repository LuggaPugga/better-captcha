		...
		declarations: [
			{
				...
				initializer: `createCaptchaComponent(${meta.providerClassName})`,
			},
		],
	});
...
function genProviderModuleCjs(meta: ProviderMetadata): string {
	...
	lines.push("");
	lines.push(
		`exports.${meta.componentName} = createCaptchaComponent(${meta.providerClassName});`,
	);
...
function genBaseCaptchaDts(): string {
	...
	sourceFile.addFunction({
		...
		parameters: [
			{
				name: "ProviderClass",
				type: "new (value: string, scriptOptions?: ScriptOptions) => TProvider",
			},
		],
