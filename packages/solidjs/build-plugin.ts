...
export declare const ${componentName}: Component<
	CaptchaProps<Omit<${renderParamsType}, ${renderParamsOmit}>, ${handleType}>
>;
...
export const unpluginFactory: UnpluginFactory<undefined> = () => {
	return {
		name: "better-captcha-generate-components-solid",
		rollup: {
			generateBundle() {
